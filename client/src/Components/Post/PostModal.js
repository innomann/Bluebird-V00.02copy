          ...
          <Content>
            <Header>
              ...
              <button onClick={(event) => reset(event)}>
                <img
                  src="https://raw.githubusercontent.com/adarshtiwari1998/linkedin-web-app/e518c8fc18f5a2cf58562f134ff3da394d02c17b/public/images/close-icon.svg"
                  alt="Close"
                />
              </button>
            </Header>
            ...
            <SharedCreation>
              <AttachAssets>
                <AssetButton onClick={() => swithchAssetArea("image")}>
                  <img
                    src="https://raw.githubusercontent.com/adarshtiwari1998/linkedin-web-app/e518c8fc18f5a2cf58562f134ff3da394d02c17b/public/images/share-image.svg"
                    alt="Share"
                  />
                </AssetButton>
                <AssetButton onClick={() => swithchAssetArea("media")}>
                  <img
                    src="https://raw.githubusercontent.com/adarshtiwari1998/linkedin-web-app/e518c8fc18f5a2cf58562f134ff3da394d02c17b/public/images/share-video.svg"
                    alt="video"
                  />
                </AssetButton>
                <AssetButton>
                  <img
                    src="https://raw.githubusercontent.com/adarshtiwari1998/linkedin-web-app/e518c8fc18f5a2cf58562f134ff3da394d02c17b/public/images/share-file.svg"
                    alt="file"
                  />
                </AssetButton>
              </AttachAssets>
              <ShareComment>
                <AssetButton>
                  <img
                    src="https://raw.githubusercontent.com/adarshtiwari1998/linkedin-web-app/e518c8fc18f5a2cf58562f134ff3da394d02c17b/public/images/share-comment.svg"
                    alt="sharecomment"
                  />
                  <span>Anyone</span>
                </AssetButton>
...
const PostButton = styled.button`
  ...
  &:hover {
    background: ${(props) =>
      props.disabled ? "rgba(0, 0, 0, 0.22)" : "#004182"};
  }
`;
